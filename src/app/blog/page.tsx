...
import CodeView from "@/app/blog/code/CodeVIew";
import TextView from "@/app/blog/text/TextView";
...
const BlogView = () => {
    ...
    return (
        <div className="flex flex-col py-2 px-4 overflow-hidden w-fit max-h-screen">
            <input
                className="mx-2 my-1 hover:text-sky-300 hover:font-bold"
                type="submit"
                value="start"
                onClick={() => setClick(1)}
            />
            <input
                className="mx-2 my-1 hover:text-orange-300 hover:font-bold"
                type="submit"
                value="end"
                onClick={() => setClick(2)}
            />
