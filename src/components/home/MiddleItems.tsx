    ...
    return (
        <div className="flex flex-row justify-between w-60">
            <MiddleItem
                ...
                text="트렌딩"
                color={index == 1 ? "black" : "#868E96"}
                onClick={() => setIndex(1)}
                border={index == 1 ? "2px solid black" : "none"}
                bold={index == 1 ? "bold" : "normal"}
            />
            <MiddleItem
                svgIcon={
                    <svg
                ...
                text={"최신"}
                color={index == 2 ? "black" : "#868E96"}
                onClick={() => setIndex(2)}
                border={index == 2 ? "2px solid black" : "none"}
                bold={index == 2 ? "bold" : "normal"}
            />
            <MiddleItem
                svgIcon={
                    <svg
                    ...
                    >
                        <g clipPath="url(#clip0_12_46)">
                            ...
                            />
                            <path
                                d="M4 4.44141V7.27141C11.03 7.27141 16.73 12.9714 16.73 20.0014H19.56C19.56 11.4114 12.59 4.44141 4 4.44141ZM4 10.1014V12.9314C7.9 12.9314 11.07 16.1014 11.07 20.0014H13.9C13.9 14.5314 9.47 10.1014 4 10.1014Z"
                                fill="#868E96"
                            />
                        </g>
                        <defs>
                ...
                text={"피드"}
                color={index == 3 ? "black" : "#868E96"}
                onClick={() => setIndex(3)}
                border={index == 3 ? "2px solid black" : "none"}
                bold={index === 3 ? "bold" : "normal"}
            />
        </div>
    );
};
